...
"false")return!1;c.append('<table class="slider-nav_wrapper"><tr><td><div class="item"></div></td></tr><tr><td><div class="slider-nav"><span class="right"><i></i></span><span class="left"><i></i></span></div></td></tr><tr><td><div class="item"></div></td></tr></table>');var k=c.children("div.slider-nav").children("span.left"),w=c.children("div.slider-nav").children("span.right");k.click(function(){n();l("prev")});w.click(function(){n();l("next")})}if(a.bullets){c.append('<ul class="orbit-bullets"></ul>');var C=c.children("ul.orbit-bullets");for(i=0;i<p;i++){k=d("<li>"+(i+1)+"</li>");if(a.bulletThumbs&&(w=e.eq(i).data("thumb")))k=d('<li class="has-thumb">'+
