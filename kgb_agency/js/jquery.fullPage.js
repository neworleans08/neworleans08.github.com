    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            $('.footer').append('<div id="' + SECTION_NAV + '"><ul></ul></div>');
            ...
            $(SECTION_NAV_SEL).find('li').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)).find('a').next().addClass(ACTIVE);
        }
        ...
        */
        function landscapeScroll(slides, destiny){
            ...
            slidesNav.find('li').eq(slideIndex).find('a').next().addClass(ACTIVE);
        }
        ...
        */
        ...
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                ...
                if(name){
                    $(SECTION_NAV_SEL).find('a[href="#' + name + '"]').next().addClass(ACTIVE);
                }else{
                    $(SECTION_NAV_SEL).find('li').eq(sectionIndex).find('a').next().addClass(ACTIVE);
                }
            }
        }
        ...
        */
        function addSlidesNavigation(section, numSlides){
            ...
            nav.find('li').first().find('div').addClass(ACTIVE);
        }
